	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if prp.Multiple {
			...
			var templ_7745c5c3_Var4 = []any{tailwind.Merge(
				...
				// a hard clip when it exceeds the field width. Height comes
				// from FormField's padding so selects match inputs exactly.
				"pl-2 pr-9 truncate",
			...
			if prp.Name != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `select.templ`, Line: 62, Col: 20}
				}
			...
			if prp.Options != nil {
				for _, option := range prp.Options {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `select.templ`, Line: 69, Col: 27}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `select.templ`, Line: 77, Col: 21}
					}
...
func selectMultiple(prp props.Select) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `select.templ`, Line: 104, Col: 34}
		}
		...
		if prp.Label != "" {
			templ_7745c5c3_Var12 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `select.templ`, Line: 111, Col: 15}
				}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 22, "<select x-model=\"selected\" multiple class=\"sr-only\" tabindex=\"-1\" aria-hidden=\"true\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if prp.Name != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `select.templ`, Line: 121, Col: 19}
			}
		...
		for _, option := range prp.Options {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `select.templ`, Line: 132, Col: 25}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `select.templ`, Line: 137, Col: 19}
			}
		...
		var templ_7745c5c3_Var17 = []any{tailwind.Merge(
			classes.FormField(),
			classes.FormFieldState(!prp.Error.Empty()),
			// min-h-8.5 (34px) matches the natural height of Input and
			// the single Select: 20px line + py-1.5 + borders.
			"flex flex-wrap items-center gap-1 min-h-8.5 py-1 pl-1 pr-1.5 mb-0",
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 34, "<div x-ref=\"field\" :style=\"'anchor-name: --' + $id('multiselect')\" class=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 35, "\"><template x-for=\"value in selected\" :key=\"value\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if !prp.Disabled {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 38, " :class=\"optionDisabled(value) ? 'pr-2' : 'pr-1'\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		...
		if !prp.Disabled {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 41, "</button></template>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 42, "</span></template><button type=\"button\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if prp.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `select.templ`, Line: 188, Col: 16}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 45, " role=\"combobox\" aria-haspopup=\"listbox\" :aria-expanded=\"open\" :aria-controls=\"$id('multiselect') + '-listbox'\" :aria-activedescendant=\"activeId\" :popovertarget=\"$id('multiselect')\" @keydown=\"onKeydown($event)\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if prp.Required {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 46, " aria-required=\"true\"")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 48, " class=\"flex flex-1 items-center gap-1 min-w-12 bg-transparent outline-none text-left text-base text-foreground disabled:cursor-not-allowed\"><span x-show=\"selected.length === 0\" class=\"truncate text-foreground-default-tertiary\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if prp.Placeholder != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `select.templ`, Line: 207, Col: 23}
			}
