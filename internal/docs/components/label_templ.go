...
func Label() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = modules.Example(modules.ExampleProps{
			Title:       "With Hint",
			Description: "Add a hint with the Hint prop. A question mark icon appears after the label and reveals a Tooltip card with the hint text on hover, parsed as Markdown. Because a label sits at the leading edge of its field, the card aligns to the start rather than centering on the icon, so it opens inwards instead of hanging off the edge.",
