...
func Input() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = modules.Example(modules.ExampleProps{
			Title:       "ISO Datetime",
			Description: "Set ISO on a datetime-local input to render a text field holding an RFC 3339 timestamp that can be read, copied, and pasted directly. The calendar button opens a single-date Calendar seeded from the field's date; Confirm replaces only the yyyy-mm-dd prefix and leaves the time and zone as typed, with no timezone conversion. Time is edited by hand. The field is validated against an RFC 3339 pattern on submit.",
		...
		templ_7745c5c3_Var7 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = examples.InputTooltipExample().Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		...
		templ_7745c5c3_Var12 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = modules.APITable(modules.APITableProps{
				...
				Items: []modules.APITableItem{
					...
					{Name: "ISO", Type: "bool", Default: "false", Description: "For datetime-local inputs, renders a text field holding an RFC 3339 timestamp with a single-date Calendar that replaces only the date prefix, leaving time and zone as typed"},
