...
func DescriptionList() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = modules.Example(modules.ExampleProps{
			...
			Description: "Inline lays the item out label-left / value-right. Actions add hover-revealed buttons (copy, external-link) next to the value, and PrefixLength / SuffixLength truncate long values (the full value is still copied). The first action doubles as the row's default: clicking anywhere on the item triggers it. Leaving Inline unset stacks the label above the value while keeping the hover reveal.",
		...
		templ_7745c5c3_Var6 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = examples.DescriptionListDetailViewExample().Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			return nil
		...
		templ_7745c5c3_Err = modules.Example(modules.ExampleProps{
			Title:       "Detail View",
			Description: "A console-style side-panel detail view: section headings, inline rows with an em-dash for absent values, and a copyable mono id row.",
			Code:        examples.LoadExample("description_list_detail_view.templ"),
		...
		templ_7745c5c3_Var7 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			templ_7745c5c3_Err = modules.APITable(modules.APITableProps{
				...
				Items: []modules.APITableItem{
					...
					{Name: "Actions", Type: "[]props.DescriptionListAction", Default: "", Description: "Hover-revealed action buttons rendered next to the value, in order of placement. The first action is also triggered by clicking anywhere on the row."},
				},
			}).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
