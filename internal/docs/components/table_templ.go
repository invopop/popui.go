...
func Table() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = modules.Example(modules.ExampleProps{
			...
			Description: "A body row that carries click wiring (onclick, the hx-* verbs, Alpine's @click or x-on:click) gets a pointer cursor automatically. Rows whose listener is attached programmatically can opt in with the data-clickable attribute.",
