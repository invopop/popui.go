...
(function() {
  ...
  popui.showToast = function(options) {
    ...
    if (!container) {
      ...
      const posStyle = toastPositionStyles[pos] || toastPositionStyles['bottom-right'];
    ...
    const icons = {
      success: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16"><path fill="#018551" d="M8 1a7 7 0 1 1 0 14A7 7 0 0 1 8 1"/><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" d="m5 8.5 2 2 4-5"/></svg>',
      error: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16"><path fill="#b30b00" d="M8 1a7 7 0 1 1 0 14A7 7 0 0 1 8 1"/><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" d="m11 5-6 6M5 5l6 6"/></svg>',
      warning: '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16"><path fill="#ec6d1b" d="M6.698 2.28a1.5 1.5 0 0 1 2.604 0l5.416 9.476A1.5 1.5 0 0 1 13.415 14H2.585a1.5 1.5 0 0 1-1.303-2.244z"/><path fill="#fff" stroke="#fff" stroke-width="1.195" d="M8 11.598c.084 0 .152.068.152.152a.153.153 0 0 1-.152.152.153.153 0 0 1-.152-.152c0-.084.069-.152.152-.152Z"/><path stroke="#fff" d="M8 5v5"/></svg>',
    ...
    Alpine.store('toasts', {
      ...
      remove(containerId, id) {
        ...
        if (toast) {
          toast.show = false;
          setTimeout(() => {
            this.items[containerId] = this.items[containerId].filter(t => t.id !== id);
          }, 300);
        }
      },
