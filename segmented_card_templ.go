...
func SegmentedCard(opts ...props.SegmentedCard) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = Card(props.Card{
			ID:         p.ID,
			Attributes: p.Attributes,
			Class: tailwind.Merge(
				"bg-background-default-secondary p-0 gap-0 border-none",
				p.Class,
			),
...
func SegmentedCardHead(opts ...props.SegmentedCardHead) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var4 = []any{tailwind.Merge(
			"text-sm font-medium text-foreground-default-secondary flex items-center justify-between gap-1 py-2 px-3",
			p.Class,
		)}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `segmented_card.templ`, Line: 1, Col: 0}
		}
...
func SegmentedCardBody(opts ...props.SegmentedCardBody) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var8 = []any{tailwind.Merge(
			"flex flex-col gap-0.5 px-0.5 pb-0.5",
			p.Class,
		)}
