...
// fades a drag handle in at each card's left edge and disables every button in
// the deck bar the toggle; clicks are captured on the deck so a card's own handlers and an
